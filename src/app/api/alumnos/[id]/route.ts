  ...
  try {
    ...
    const alumnoActualizado = await prisma.alumno.update({
      ...
      data: {
        ...
        pagaOtrosPagos: pagaOtrosPagos !== undefined ? pagaOtrosPagos : alumnoExistente.pagaOtrosPagos,
        otrosPagos: pagaOtrosPagos && otrosPagos ? parseFloat(otrosPagos) : (pagaOtrosPagos === false ? null : alumnoExistente.otrosPagos),
